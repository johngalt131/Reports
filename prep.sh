...
sed -n '/BEGINCASE/,/ENDCASE/ p' | sed '1d;$d' < $GETTER_SETTER_METHODS_FILE >> tmp
...
sed -n '/BEGINPROTOTYPES/,/ENDPROTOTYPES/ p' | sed '1d;$d' < $GETTER_SETTER_METHODS_FILE >> tmp
...
sed -n '/BEGINIMPLEMENTATION/,/ENDIMPLEMENTATION/ p' | sed '1d;$d' < $GETTER_SETTER_METHODS_FILE >> tmp
...
sed -n '/BEGINCONSTRUCTOR/,/ENDCONSTRUCTOR/ p' | sed '1d;$d' < $GETTER_SETTER_METHODS_FILE >> tmp
sed -n '/ENDCONSTRUCTOR/,$ p' < $FUNCTION_IMPLEMENTATIONS_FILE >> tmp
mv tmp $FUNCTION_IMPLEMENTATIONS_FILE
